...
export default function DiagnosticTool() {
  ...
  async function handleStart() {
    ...
    try {
      const resp = await startTest(url, type);
      ...
      <div className="bg-card rounded-2xl p-6 shadow-md">
        ...
        <div className="mt-6 space-y-4">
          <div>
            ...
            <input value={url} onChange={e=>setUrl(e.target.value)} placeholder="https://api.example.com/v1/health"
          ...
          <div className="flex items-center space-x-3">
            ...
            <button onClick={()=>{ setUrl(""); setType("basic"); }} className="px-4 py-2 rounded-2xl bg-[#111418] border border-[#263038]">
              Reset
            </button>
          </div>
